    ...
    >
      <header className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-white shadow-md py-2' : 'bg-transparent py-4'}`}>
        <div className="container mx-auto px-6 flex justify-between items-center">
          ...
          <img src="/images/main4.svg" alt="OPBG 로고" className="w-[150px] h-auto rounded-lg" 
...
/>          </NavLink>
          ...
          <nav className="hidden md:flex space-x-8 text-[16px]">
            ...
            <NavLink to="/dashboard" className={({ isActive }) => isActive ? 'text-purple-600' : 'text-gray-700 hover:text-purple-600'}>뱃지추천</NavLink>
